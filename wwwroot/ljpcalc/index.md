...
* **`Âµ`** (mu) is [ionic mobility](https://en.wikipedia.org/wiki/Electrical_mobility)
...
Ionic mobility is **`Âµ = Î› / (N * eÂ² * |z|)`** where:

* **`Âµ`** (mu) is [ionic mobility](https://en.wikipedia.org/wiki/Electrical_mobility) (mÂ² / V / sec)
* **`Î›`** (Lambda) is [molar conductivity](https://en.wikipedia.org/wiki/Molar_conductivity) (S * cmÂ²/ mol)
